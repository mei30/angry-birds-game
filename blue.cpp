...
void Blue::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    {
        _shooted = true;
        _body->ApplyLinearImpulse(b2Vec2(150/RATIO, 150/RATIO), _body->GetWorldCenter());
    }
}
...
void Blue::reactionToClick()
{
    ...
    this->_body->ApplyLinearImpulse(b2Vec2(150/RATIO, 0), _body->GetWorldCenter());
    blue2->_body->ApplyLinearImpulse(b2Vec2(150/RATIO, 150/RATIO), blue2->_body->GetWorldCenter());
    blue3->_body->ApplyLinearImpulse(b2Vec2(150/RATIO, -150/RATIO),blue3->_body->GetWorldCenter());
